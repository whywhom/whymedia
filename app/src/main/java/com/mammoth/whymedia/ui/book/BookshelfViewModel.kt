...
import com.mammoth.whymedia.BuildConfig
import com.mammoth.whymedia.MediaApplication
import com.mammoth.whymedia.db.BookDatabase
...
import utils.EventChannel
import utils.extensions.copyToTempFile
import utils.extensions.moveTo
...
class BookshelfViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private var server: Server = MediaApplication.server
    ...
    private var r2Directory: String = MediaApplication.R2DIRECTORY
    ...
    fun deleteBook(book: Book) = viewModelScope.launch {
        ...
        tryOrNull { File("${MediaApplication.R2DIRECTORY}covers/${book.id}.png").delete() }
    }
